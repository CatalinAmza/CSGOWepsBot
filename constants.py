...
STEAM_ID =  # insert your steamid here
...
STEAM_RETRY_LIMIT = 300
LOUNGE_RETRY_LIMIT = 5
WEAPON_ATTRIBUTES = 6

WEAPON_WEAR_ID = 1
HIGHLIGHT_FACTOR = 0.0005
REDDIT_THREAD_QUEUE_DEFAULT_COUNT = 54 #50 #55
REDDIT_TRICK_1 = 6
...
LOUNGE_THREAD_ID_QUEUE = "trade?t="
LOUNGE_THREAD_ID_END = "\""
LOUNGE_ID_QUEUE = "profile?id="
LOUNGE_ID_END = "\""
REDDIT_HEADER = {"User-Agent": "pc:csgotrade:v4 by /u/thespecificdude"}
...
VAULT_FOLDER = "vault\\"
SEPARATOR = "|"
WEAPON_ID_ID = 6 #should be a class field for Log
...
LOUNGE_ERROR_MSG = "You messed up."
...
API_UNSUCCESSFUL = "Retrying to get the API contents"
